module Champion
  ...
  TAGS = {
    ...
    "engage" => "You like the fight to start on your terms",
    "disengage" => "DISENGAGE, DISENGAGE!!",
    "peel" => "You keep your carries safe",
    ...
    "split" => "You play champs that split well",
    "pusher" => "I'll split, have TP",
    "healer" => "You bring life to friends",
    ...
    "mana_based" => "You like those mana hungry champs",
    "health_based" => "You masochist.",
    "rage_based" => "RAWR you like rage based champs",
    "cooldown_based" => "You believe resourceless is the way to go",
    "shield" => "You protect your friends",
    "dot" => "You would rather kill your enemies slowly",
    "dash" => "Mobility!",
    "global" => "You dominate the map with your globals",
    "waveclear" => "You are the ultimate anti seige machine",
    "savior" => "You stop your friends from dying :)",
  ...
  CHAMPIONS = {
    ...
    "39" => {"name" => "Irelia", "image" => "Irelia.png", "tags" => ["reset", "triforce", "fighter", "duelist", "split"]},
    "157" => {"name" => "Yasuo", "image" => "Yasuo.png", "tags" => ["cooldown_based"]},
    "37" => {"name" => "Sona", "image" => "Sona.png", "tags" => ["shield", "healer", "wombo"]},
    ...
    "3" => {"name" => "Galio", "image" => "Galio.png", "tags" => ["hard_cc", "wombo", "mage"]},
    "161" => {"name" => "Vel'Koz", "image" => "Velkoz.png", "tags" => ["poke", "liandrys", "mage" ]},
    "2" => {"name" => "Olaf", "image" => "Olaf.png", "tags" => ["engage", "fighter"]},
    "1" => {"name" => "Annie", "image" => "Annie.png", "tags" => ["mage", "hard_cc", "burst", "engage"]},
    "7" => {"name" => "LeBlanc", "image" => "Leblanc.png", "tags" => ["assassin", "mage"]},
    "30" => {"name" => "Karthus", "image" => "Karthus.png", "tags" => ["death_passive", "mage", "global"]},
    "6" => {"name" => "Urgot", "image" => "Urgot.png", "tags" => ["mana_based", "hard_cc"]},
    "32" => {"name" => "Amumu", "image" => "Amumu.png", "tags" => ["tank", "jungler", "hard_cc", "wombo", "engage"]},
    ...
    "4" => {"name" => "Twisted Fate", "image" => "TwistedFate.png", "tags" => ["mage", "poke", "global", "hard_cc"]},
    ...
    "18" => {"name" => "Tristana", "image" => "Tristana.png", "tags" => ["reset", "pusher", "marksman", "attack_speed", "dash"]},
    "15" => {"name" => "Sivir", "image" => "Sivir.png", "tags" => ["shield", "marksman", "waveclear", "engage"]},
    "16" => {"name" => "Soraka", "image" => "Soraka.png", "tags" => ["healer", "global", "savior"]},
    "13" => {"name" => "Ryze", "image" => "Ryze.png", "tags" => ["mage", "duelist"]},
    "14" => {"name" => "Sion", "image" => "Sion.png", "tags" => ["tank", "engage"]},
    "11" => {"name" => "Master Yi", "image" => "MasterYi.png", "tags" => ["reset", "hypercarry", "fighter"]},
    ...
    "105" => {"name" => "Fizz", "image" => "Fizz.png", "tags" => ["mage", "assassin", "burst"]},
    "104" => {"name" => "Graves", "image" => "Graves.png", "tags" => ["marksman", "burst"]},
    "103" => {"name" => "Ahri", "image" => "Ahri.png", "tags" => ["assassin", "mage", "hard_cc"]},
    ...
    "101" => {"name" => "Xerath", "image" => "Xerath.png", "tags" => ["mage", "waveclear", "poke"]},
    ...
    "92" => {"name" => "Riven", "image" => "Riven.png", "tags" => ["cooldown_based", "fighter", "hard_cc"]},
    "91" => {"name" => "Talon", "image" => "Talon.png", "tags" => ["assassin", "stealth"]},
    "90" => {"name" => "Malzahar", "image" => "Malzahar.png", "tags" => ["mage", "hard_cc", "pusher", "waveclear"]},
    ...
    "421" => {"name" => "Rek'Sai", "image" => "RekSai.png", "tags" => ["jungler", "rage_based", "knockup"]},
    "89" => {"name" => "Leona", "image" => "Leona.png", "tags" => ["tank", "hard_cc", "engage", "peel", "support"]},
    "79" => {"name" => "Gragas", "image" => "Gragas.png", "tags" => ["disengage", "tank", "hard_cc", "engage", "jungler"]},
    "117" => {"name" => "Lulu", "image" => "Lulu.png", "tags" => ["shield", "mage", "support", "knockup"]},
    "114" => {"name" => "Fiora", "image" => "Fiora.png", "tags" => ["duelist"]},
    "78" => {"name" => "Poppy", "image" => "Poppy.png", "tags" => ["hard_cc", "duelist", "triforce", "engage"]},
    "115" => {"name" => "Ziggs", "image" => "Ziggs.png", "tags" => ["poke", "mage"]},
    "77" => {"name" => "Udyr", "image" => "Udyr.png", "tags" => ["mana_based", "split", "hard_cc", "triforce"]},
    "112" => {"name" => "Viktor", "image" => "Viktor.png", "tags" => ["waveclear", "mage", "poke"]},
    "113" => {"name" => "Sejuani", "image" => "Sejuani.png", "tags" => ["engage", "hard_cc", "jungler"]},
    "110" => {"name" => "Varus", "image" => "Varus.png", "tags" => ["poke", "mana_based", "marksman", "hard_cc"]},
    "111" => {"name" => "Nautilus", "image" => "Nautilus.png", "tags" => ["tank", "jungler", "hard_cc", "support", "peel", "engage"]},
    ...
    "83" => {"name" => "Yorick", "image" => "Yorick.png", "tags" => ["fighter", "mana_based", "savior"]},
    ...
    "84" => {"name" => "Akali", "image" => "Akali.png", "tags" => ["reset", "dash", "energy_based", "assassin", "burst", "stealth"]},
    ...
    "127" => {"name" => "Lissandra", "image" => "Lissandra.png", "tags" => ["hard_cc", "dash", "mage"]},
    ...
    "122" => {"name" => "Darius", "image" => "Darius.png", "tags" => ["juggernaut", "wombo", "reset"]},
    ...
    "74" => {"name" => "Heimerdinger", "image" => "Heimerdinger.png", "tags" => ["mage", "hard_cc", "waveclear"]},
    ...
    "134" => {"name" => "Syndra", "image" => "Syndra.png", "tags" => ["hard_cc", "burst", "duelist"]},
    ...
    "55" => {"name" => "Katarina", "image" => "Katarina.png", "tags" => ["reset", "cooldown_based", "mage"]},
    "64" => {"name" => "Lee Sin", "image" => "LeeSin.png", "tags" => ["jungler", "fighter", "engage"]},
    "62" => {"name" => "Wukong", "image" => "MonkeyKing.png", "tags" => ["engage", "hard_cc", "fighter", "knockup"]},
    "63" => {"name" => "Brand", "image" => "Brand.png", "tags" => ["liandrys", "hard_cc", "wombo", "mage"]},
    "268" => {"name" => "Azir", "image" => "Azir.png", "tags" => ["attack_speed", "mage", "disengage"]},
    "267" => {"name" => "Nami", "image" => "Nami.png", "tags" => ["disengage", "engage", "healer"]},
    "60" => {"name" => "Elise", "image" => "Elise.png", "tags" => ["dive", "engage", "mana_based", "jungler", "hard_cc"]},
    "131" => {"name" => "Diana", "image" => "Diana.png", "tags" => ["assassin", "attack_speed", "engage"]},
    "61" => {"name" => "Orianna", "image" => "Orianna.png", "tags" => ["wombo", "mage", "knockup"]},
    "266" => {"name" => "Aatrox", "image" => "Aatrox.png", "tags" => ["death_passive", "split"]},
    "143" => {"name" => "Zyra", "image" => "Zyra.png", "tags" => ["liandrys", "hard_cc", "knockup", "wombo", "engage", "burst"]},
    "48" => {"name" => "Trundle", "image" => "Trundle.png", "tags" => ["fighter", "dive"]},
    "45" => {"name" => "Veigar", "image" => "Veigar.png", "tags" => ["burst", "mage", "hard_cc"]},
    "44" => {"name" => "Taric", "image" => "Taric.png", "tags" => ["hard_cc", "tank", "peel"]},
    "51" => {"name" => "Caitlyn", "image" => "Caitlyn.png", "tags" => ["marksman", "attack_speed", "pusher", "dash"]},
    ...
    "50" => {"name" => "Swain", "image" => "Swain.png", "tags" => ["mage", "dot", "hard_cc", "liandrys"]}
  }
